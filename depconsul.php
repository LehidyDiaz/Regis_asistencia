...
<body>
    ...
    <section class="home">
        <div class="text">Lista de Oficinas
            <div class="consultar">
                <form action="depconsul.php" method="post">
                ...
                <div class="crear">
                    <a href='depcreate.php'>
                        <input type="submit" class="btn" value="Nuevo oficina"> <br></br>
                    </a>
                </div>
                <style>
                    .imagen-pequena {
                ...
                <table>
                    ...
                    <?php
                    $sql = "SELECT * FROM oficina WHERE nombre LIKE '%$busqueda%'";
                    ...
                    while ($row = mysqli_fetch_assoc($resultado)) {
                        ...
                        echo "<td><a href='depupdate.php?idOficina={$row['idOficina']}' class='btn'>Editar</a> 
                        <a href='depdelete.php?idOficina={$row['idOficina']}' class='btn'>Borrar</a>";
                        echo "</tr>";
                    }
                    ?>
