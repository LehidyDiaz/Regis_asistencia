...
if (isset($_POST['create'])) {
    ...
    $sql = "INSERT INTO oficina (nombre, telefono) VALUES ('$nombre', '$telefono')";

        if (mysqli_query($enlace, $sql)) {
            echo "<script>
                alert('La oficina se ha subido correctamente.');
...
<body>
    ...
    <section class="home">
        <div class="text">Crear Nueva oficina
            <div class="consultar">
                <form action="depcreate.php" method="POST" enctype="multipart/form-data">
