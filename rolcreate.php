...
if (isset($_POST['create'])) {
    ...
    echo "salarioBase: " . $salarioBase . "<br>";


    $sql = "INSERT INTO rol (nombre, salarioBase) VALUES ('$nombre', '$salarioBase')";

        if (mysqli_query($enlace, $sql)) {
            echo "<script>
                alert('La rol se ha subido correctamente.');
...
<body>
    ...
    <section class="home">
        <div class="text">Crear Nuevo Rol
            <div class="consultar">
                <form action="rolcreate.php" method="POST" enctype="multipart/form-data">
                    <label for="nombre">Rol:</label>
                    <input type="text" id="nombre" name="nombre" required><br>
                    <label for="salarioBase">Salario Base:</label>
                    <input type="text" id="salarioBase" name="salarioBase" required><br>
