...
<body>
    ...
    <section class="home">
        <div class="text">Contactos de Emergencia
            <div class="consultar">
                <form action="contconsul.php" method="post">
                ...
                <div class="crear">
                    <a href='contcreate.php'>
                        <input type="submit" class="btn" value="Nuevo Contacto de Emergencia"> <br></br>
                    </a>
                </div>
                <table>
                    <thead>
